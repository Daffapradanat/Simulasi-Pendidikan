      ...
      <div className="section-card">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <ImportExportMenu type="teachers" />
              ...
              {teachers.length === 0 ? (
                <tr>
                  <td colSpan={7} style={{ textAlign: "center", padding: "48px 32px", color: "var(--text-muted)" }}>
                    ...
                    <h3 style={{ fontSize: "16px", fontWeight: 600, color: "var(--text)", margin: "0 0 8px" }}>Belum Ada Data Guru</h3>
                    <p style={{ margin: 0, fontSize: "14px" }}>Silakan tambah data guru secara manual atau import via Excel.</p>
                  </td>
                </tr>
                ...
                displayedTeachers.map((t: any, index: number) => (
